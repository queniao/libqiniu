...
QN_SDK extern qn_http_header_ptr qn_http_hdr_create(void);
QN_SDK extern void qn_http_hdr_destroy(qn_http_header_ptr restrict hdr);
QN_SDK extern void qn_http_hdr_reset(qn_http_header_ptr restrict hdr);

QN_SDK extern int qn_http_hdr_count(qn_http_header_ptr restrict hdr);
...
QN_SDK extern qn_bool qn_http_hdr_set_integer(qn_http_header_ptr restrict hdr, const char * restrict key, int val);
QN_SDK extern void qn_http_hdr_unset(qn_http_header_ptr restrict hdr, const char * restrict key);

// ---- Declaration of HTTP header iterator ----

typedef void * qn_http_hdr_iterator_ptr;

QN_SDK extern qn_http_hdr_iterator_ptr qn_http_hdr_itr_create(qn_http_header_ptr restrict hdr);
QN_SDK extern void qn_http_hdr_itr_destroy(qn_http_hdr_iterator_ptr restrict itr);
