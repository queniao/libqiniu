...
QN_API extern qn_string qn_http_hdr_get_entry_raw(qn_http_header_ptr restrict hdr, const char * restrict key, size_t key_size);
...
QN_API extern qn_bool qn_http_hdr_get_raw(qn_http_header_ptr restrict hdr, const char * key, size_t key_size, const char ** restrict val, size_t * restrict val_size);

static inline qn_bool qn_http_hdr_get(qn_http_header_ptr restrict hdr, const qn_string key, const char ** restrict val, size_t * restrict val_size)
{
...
QN_API extern void qn_http_hdr_unset_raw(qn_http_header_ptr restrict hdr, const char * restrict key, size_t key_size);
