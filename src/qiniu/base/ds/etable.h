...
QN_API extern void qn_etbl_destroy(qn_etable_ptr restrict etbl);
...
QN_API extern qn_bool qn_etbl_set_raw(qn_etable_ptr restrict etbl, const char * restrict key, size_t key_size, const char * restrict val, size_t val_size);
...
QN_API extern qn_bool qn_etbl_set_integer(qn_etable_ptr restrict etbl, const char * restrict key, int value);

QN_API extern void qn_etbl_unset(qn_etable_ptr restrict etbl, const char * restrict key);
...
QN_API extern qn_etbl_iterator_ptr qn_etbl_itr_create(qn_etable_ptr restrict etbl);
QN_API extern void qn_etbl_itr_destroy(qn_etbl_iterator_ptr restrict itr);
QN_API extern void qn_etbl_itr_rewind(qn_etbl_iterator_ptr restrict itr);

QN_API extern qn_string qn_etbl_itr_next_entry(qn_etbl_iterator_ptr restrict itr);
QN_API extern qn_bool qn_etbl_itr_next_pair_raw(qn_etbl_iterator_ptr restrict itr, const char ** restrict key, size_t * restrict key_size, const char ** restrict val, size_t * restrict val_size);
