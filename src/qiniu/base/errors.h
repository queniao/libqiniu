...
QN_SDK extern void qn_err_set_code(qn_err_code_em cd, const char * restrict file, int line);
QN_SDK extern qn_err_code_em qn_err_get_code(void);

// ----

#define qn_err_set_succeed() qn_err_set_code(QN_ERR_SUCCEED, __FILE__, __LINE__)
#define qn_err_set_out_of_memory() qn_err_set_code(QN_ERR_OUT_OF_MEMORY, __FILE__, __LINE__)
#define qn_err_set_try_again() qn_err_set_code(QN_ERR_TRY_AGAIN, __FILE__, __LINE__)
#define qn_err_set_invalid_argument() qn_err_set_code(QN_ERR_INVALID_ARGUMENT, __FILE__, __LINE__)
#define qn_err_set_overflow_upper_bound() qn_err_set_code(QN_ERR_OVERFLOW_UPPER_BOUND, __FILE__, __LINE__)
#define qn_err_set_overflow_lower_bound() qn_err_set_code(QN_ERR_OVERFLOW_LOWER_BOUND, __FILE__, __LINE__)
#define qn_err_set_bad_utf8_sequence() qn_err_set_code(QN_ERR_BAD_UTF8_SEQUENCE, __FILE__, __LINE__)
#define qn_err_set_out_of_buffer() qn_err_set_code(QN_ERR_OUT_OF_BUFFER, __FILE__, __LINE__)
#define qn_err_set_out_of_capacity() qn_err_set_code(QN_ERR_OUT_OF_CAPACITY, __FILE__, __LINE__)
#define qn_err_set_no_such_entry() qn_err_set_code(QN_ERR_NO_SUCH_ENTRY, __FILE__, __LINE__)
#define qn_err_set_out_of_range() qn_err_set_code(QN_ERR_OUT_OF_RANGE, __FILE__, __LINE__)

#define qn_err_json_set_bad_text_input() qn_err_set_code(QN_ERR_JSON_BAD_TEXT_INPUT, __FILE__, __LINE__)
#define qn_err_json_set_too_many_parsing_levels() qn_err_set_code(QN_ERR_JSON_TOO_MANY_PARSING_LEVELS, __FILE__, __LINE__)
#define qn_err_json_set_need_more_text_input() qn_err_set_code(QN_ERR_JSON_NEED_MORE_TEXT_INPUT, __FILE__, __LINE__)
#define qn_err_json_set_modifying_immutable_object() qn_err_set_code(QN_ERR_JSON_MODIFYING_IMMUTABLE_OBJECT, __FILE__, __LINE__)
#define qn_err_json_set_modifying_immutable_array() qn_err_set_code(QN_ERR_JSON_MODIFYING_IMMUTABLE_ARRAY, __FILE__, __LINE__)
#define qn_err_json_set_out_of_index() qn_err_set_code(QN_ERR_JSON_OUT_OF_INDEX, __FILE__, __LINE__)

#define qn_err_http_set_invalid_header_syntax() qn_err_set_code(QN_ERR_HTTP_INVALID_HEADER_SYNTAX, __FILE__, __LINE__)
#define qn_err_http_set_adding_string_field_failed() qn_err_set_code(QN_ERR_HTTP_ADDING_STRING_FIELD_FAILED, __FILE__, __LINE__)
#define qn_err_http_set_adding_file_field_failed() qn_err_set_code(QN_ERR_HTTP_ADDING_FILE_FIELD_FAILED, __FILE__, __LINE__)
#define qn_err_http_set_adding_buffer_field_failed() qn_err_set_code(QN_ERR_HTTP_ADDING_BUFFER_FIELD_FAILED, __FILE__, __LINE__)

#define qn_err_fl_set_opening_file_failed() qn_err_set_code(QN_ERR_FL_OPENING_FILE_FAILED, __FILE__, __LINE__)
#define qn_err_fl_set_duplicating_file_failed() qn_err_set_code(QN_ERR_FL_DUPLICATING_FILE_FAILED, __FILE__, __LINE__)
#define qn_err_fl_set_reading_file_failed() qn_err_set_code(QN_ERR_FL_READING_FILE_FAILED, __FILE__, __LINE__)
#define qn_err_fl_set_seeking_file_failed() qn_err_set_code(QN_ERR_FL_SEEKING_FILE_FAILED, __FILE__, __LINE__)

#define qn_err_fl_info_set_stating_file_info_failed() qn_err_set_code(QN_ERR_FL_INFO_STATING_FILE_INFO_FAILED, __FILE__, __LINE__)

#define qn_err_stor_set_lack_of_authorization_information() qn_err_set_code(QN_ERR_STOR_LACK_OF_AUTHORIZATION_INFORMATION, __FILE__, __LINE__)
#define qn_err_stor_set_invalid_resumable_session_information() qn_err_set_code(QN_ERR_STOR_INVALID_RESUMABLE_SESSION_INFORMATION, __FILE__, __LINE__)
#define qn_err_stor_set_invalid_list_result() qn_err_set_code(QN_ERR_STOR_INVALID_LIST_RESULT, __FILE__, __LINE__)
#define qn_err_stor_set_upload_aborted_by_filter_pre_callback() qn_err_set_code(QN_ERR_STOR_UPLOAD_ABORTED_BY_FILTER_PRE_CALLBACK, __FILE__, __LINE__)
#define qn_err_stor_set_upload_aborted_by_filter_post_callback() qn_err_set_code(QN_ERR_STOR_UPLOAD_ABORTED_BY_FILTER_POST_CALLBACK, __FILE__, __LINE__)
#define qn_err_stor_set_invalid_chunk_put_result() qn_err_set_code(QN_ERR_STOR_INVALID_CHUNK_PUT_RESULT, __FILE__, __LINE__)
#define qn_err_stor_set_api_return_no_value() qn_err_set_code(QN_ERR_STOR_API_RETURN_NO_VALUE, __FILE__, __LINE__)
#define qn_err_stor_set_lack_of_block_context() qn_err_set_code(QN_ERR_STOR_LACK_OF_BLOCK_CONTEXT, __FILE__, __LINE__)
#define qn_err_stor_set_lack_of_file_size() qn_err_set_code(QN_ERR_STOR_LACK_OF_FILE_SIZE, __FILE__, __LINE__)
#define qn_err_stor_set_lack_of_block_info() qn_err_set_code(QN_ERR_STOR_LACK_OF_BLOCK_INFO, __FILE__, __LINE__)
#define qn_err_stor_set_invalid_upload_result() qn_err_set_code(QN_ERR_STOR_INVALID_UPLOAD_RESULT, __FILE__, __LINE__)

#define qn_err_etag_set_initializing_context_failed() qn_err_set_code(QN_ERR_ETAG_INITIALIZING_CONTEXT_FAILED, __FILE__, __LINE__)
#define qn_err_etag_set_updating_context_failed() qn_err_set_code(QN_ERR_ETAG_UPDATING_CONTEXT_FAILED, __FILE__, __LINE__)
#define qn_err_etag_set_initializing_block_failed() qn_err_set_code(QN_ERR_ETAG_INITIALIZING_BLOCK_FAILED, __FILE__, __LINE__)
#define qn_err_etag_set_updating_block_failed() qn_err_set_code(QN_ERR_ETAG_UPDATING_BLOCK_FAILED, __FILE__, __LINE__)
#define qn_err_etag_set_making_digest_failed() qn_err_set_code(QN_ERR_ETAG_MAKING_DIGEST_FAILED, __FILE__, __LINE__)

#define qn_err_easy_set_invalid_uptoken() qn_err_set_code(QN_ERR_EASY_INVALID_UPTOKEN, __FILE__, __LINE__)
#define qn_err_easy_set_invalid_put_policy() qn_err_set_code(QN_ERR_EASY_INVALID_PUT_POLICY, __FILE__, __LINE__)
