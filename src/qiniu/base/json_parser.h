...
extern qn_bool qn_json_prs_parse_object(qn_json_parser_ptr prs, const char * restrict buf, qn_size * restrict buf_size, qn_json_object_ptr * root);
extern qn_bool qn_json_prs_parse_array(qn_json_parser_ptr prs, const char * restrict buf, qn_size * restrict buf_size, qn_json_array_ptr * root);
