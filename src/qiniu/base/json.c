...
QN_SDK qn_bool qn_json_replace_variant(qn_json_array_ptr restrict arr, int n, qn_json_class cls, qn_json_variant var)
{
    assert(arr);
    assert(0 <= n);
    ...
    return qn_json_arr_replace(arr, n, cls, var);
}
