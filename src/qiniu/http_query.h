...
QN_API extern qn_bool qn_http_qry_set_text(qn_http_query_ptr restrict qry, const char * restrict key, const char * restrict val, size_t val_size);
...
{
    return qn_http_qry_set_text(qry, key, val, strlen(val));
}
